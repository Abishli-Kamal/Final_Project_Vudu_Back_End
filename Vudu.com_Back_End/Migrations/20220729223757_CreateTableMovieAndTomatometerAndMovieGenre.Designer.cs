...
namespace Vudu.com_Back_End.Migrations
{
    ...
    [Migration("20220729223757_CreateTableMovieAndTomatometerAndMovieGenre")]
    partial class CreateTableMovieAndTomatometerAndMovieGenre
    {
            ...
            modelBuilder.Entity("Vudu.com_Back_End.Models.Movie", b =>
                {
                    ...
                    b.Property<int?>("TomatometerId")
                        .HasColumnType("int");

                    b.Property<int?>("TomoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vudu.com_Back_End.Models.Movie", b =>
                {
                    ...
                    b.HasOne("Vudu.com_Back_End.Models.Tomatometer", "Tomatometer")
                        .WithMany("Movies")
                        .HasForeignKey("TomatometerId");
